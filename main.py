...
# autoencoder = Autoencoder(X_train.shape[1], y_train.shape[1], embedding_size=200, vocab_size=vocab_size, n_gram=n_gram_n, bits_per_token=bits)
...
autoencoder = Autoencoder(X_train.shape[1], y_train.shape[1], vocab_size=vocab_size, n_gram=n_gram_n, bits_per_token=bits)
